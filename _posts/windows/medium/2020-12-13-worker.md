...
tags: [htb, hacking, hack the box, redteam, windows, web, .net, azure, svn, subversion, oscp, tj_null, medium, writeup, ekenas, unfinished]     # TAG names should always be lowercase
...
I started my enumeration with an nmap scan of `10.10.10.203`.  The options I regularly use are: 
...
![](/assets/img/11-test-fixed-pull.png)
...
![](/assets/img/14-run.png)

Save and run

![](/assets/img/15-building%20%281%29.png)
