...
![Descriptive information card on the machine resolute](/assets/img/resolute-infocard.png)
...
I started my enumeration with an nmap scan of `10.10.10.169`.  The options I regularly use are: 
