...
tags: [htb, hacking, hack the box, redteam, windows, smb, sql, metasploit, ldap, kerberos, vnc, .net, active directory, powershell, medium, writeup, vbscrub]     # TAG names should always be lowercase
---
...
I used a little trick I had learned on the machine [`Nest`](2020-05-31-nest.md) for downloading all of the files in an SMB folder recursively.  After downloading all of the files, I browsed through my loot.
