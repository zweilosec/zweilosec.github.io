...
tags: [htb, hacking, hack the box, redteam, windows, impacket, powershell, web, ldap, psexec, autologon, kerberos, pass the hash, metasploit, easy, writeup, egotisticalsw]     # TAG names should always be lowercase
---
...
![](/assets/img/1-sauna-infocard.png)
