...
tags: [htb, hacking, hack the box, redteam, windows, umbraco, powershell, python, nfs, showmount, teamviewer, easy, writeup, mrb3n, unfinished]     # TAG names should always be lowercase
...
![](/assets/img/0-remote-infocard.png)
...
![](/assets/img/9-notvulnerable.png)

rabbit hole?^

![](/assets/img/3-umbraco.png)
