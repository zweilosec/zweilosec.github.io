...
tags: [htb, hacking, hack the box, redteam, windows, impacket, powershell, web, ipv6, rpc, python, kerberos, pass the hash, ntlm, lmcompatibilitylevel, responder, ntp, registry, insane, writeup, cube0x0, unfinished]     # TAG names should always be lowercase
---
