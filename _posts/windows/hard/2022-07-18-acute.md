...
In case it was useful I took note of the Physical Path of the PowerShell Web Access directory on the server: `%windir%/Web/PowerShellWebAccess/wwwroot`.  there was an interesting security note regarding what sounded like a way to pivot to other computers.
