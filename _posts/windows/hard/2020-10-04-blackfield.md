---
description: >-
  Zweilosec's writeup on the hard-difficulty machine Blackfield from
  https://hackthebox.eu
...
![](/assets/img/1-bloodhound-stats.png)

Bloodhound reported 342 \(!\) users on this domain. 

![](/assets/img/2-bloodhound-targets.png)
...
![](/assets/img/3-bloodhound-forcepassword.png)
...
![](/assets/img/1.1-rpcclient-info.png)

![](/assets/img/1.2-rpcclient-info2.png)

![](/assets/img/1.3-rpcclient-info3.png)
...
![](/assets/img/1.3-net-password.png)
