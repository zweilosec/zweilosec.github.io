...
My nmap scan showed that there were only two TCP ports open on this machine:  22 - SSH abd 80 - HTTP.
...
Since PHP did not seem to execute, I decided to try uploadin a bash reverse shell instead.
