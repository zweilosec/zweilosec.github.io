---
description: >-
  Zweilosec's write-up of the Insane difficulty Linux Dyplesher machine from
  https://hackthebox.eu
title: Hack the Box - Dyplesher Writeup
...
![](/assets/img/0-dyplesher-infocard.png)
...
![](/assets/img/1-dyplesher-minecraft.png)
...
![](/assets/img/3-tekkit-minecraft.png)
...
![](/assets/img/8-felamos-index.png)
...
![](/assets/img/11-gitlab-code-4e.png)
...
![](/assets/img/14-loginsecurity-configyml.png)

The file `config.yml` had more database credentials, this time for a MySQL database.

### The users database

![](/assets/img/14-loginsecurity-usersdb.png)
...
![](/assets/img/14-loginsecurity-usersdb-password.png)
...
![](/assets/img/17-wireshark-erlang-rabbit%20%281%29%20%281%29%20%281%29.png)

I noticed pretty quickly the Erlang Port Mapper traffic identifying port 25672 as a RabbitMQ node.

![](/assets/img/17-wireshark-memcached.png)
...
![](/assets/img/17-wireshark-amqp%20%281%29.png)
...
![](/assets/img/18-backup-script.png)
...
![](/assets/img/20-cuberite-webadmin.png)
