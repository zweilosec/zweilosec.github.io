...
tags: [htb, hacking, hack the box, redteam, linux, python, metasploit, web, bludit, sudo, python, oscp, tj_null, easy, writeup, egotisticalsw]     # TAG names should always be lowercase
show_image_post: true
image: /assets/img/screenshot-2020-10-27-201546.png
---
...
I started my enumeration with an nmap scan of `10.10.10.191`.  The options I regularly use are: 
...
```text
zweilos@kali:~/htb/blunder$ nmap -p- -sC -sV -oA blunder 10.10.10.191
