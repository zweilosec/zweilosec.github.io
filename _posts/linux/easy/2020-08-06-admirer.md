...
tags: [htb, hacking, hack the box, redteam, linux, sudo, setenv, bash, sql, mysql, php, ssh, web, adminer, easy, writeup, polarbearer, gibparadox]     # TAG names should always be lowercase
---
...
![](/assets/img/0-admirer-infocard.png)
...
![](/assets/img/1-admirer-website.png)
...
![](/assets/img/5.5-config-file.png)
...
![](/assets/img/6-adminer-login%20%281%29.png)
...
![](/assets/img/7-failed-local-inclusion%20%282%29%20%282%29%20%282%29%20%282%29%20%282%29%20%281%29.png)
...
![](/assets/img/8-local-inclusion-success.png)
...
![](/assets/img/9-yet-another-password.png)
